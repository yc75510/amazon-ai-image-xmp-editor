...
export default function Home() {
  ...
  return <main id="top">
    ...
    <a className="back-to-top" href="#top" aria-label={t("Back to top", "返回顶部")} title={t("Back to top", "返回顶部")}>↑</a>{toast && <div className="toast" role="status"><span>✓</span>{toast}<button onClick={() => setToast(undefined)} aria-label="Dismiss notification">×</button></div>}<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: structuredData }} />
  </main>;
}
